...
import com.unltm.distance.activity.live.player.PlayerActivity
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.MainScope
import kotlinx.coroutines.launch
import kotlinx.coroutines.withContext

class DiscoveryAdapter : PagingDataAdapter<LivePreview, DiscoveryAdapter.PreviewViewHolder>(DIFF) {
